namespace PortalRestService.Helper
{
    public class APIConstant
    {
        ...
        public const string GetSummaryStatusData = "https://run.mocky.io/v3/7c57d47c-6a06-4d8e-b17c-d868c01748e4";
        ...
        public const string GetDispenserByLocation = "api/Dispenser/getdispenserbylocationid?Id=";

        public const string GetAllLocation = "api/Location/getAllLocation";  //Auther: Pradeep, Date 19/07/2022

        public const string GetAllDispenser = "api/Dispenser/getAllDispenser";     //Auther: Pradeep, Date 19/07/2022
